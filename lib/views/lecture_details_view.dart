        ...
        return Padding(
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                      lecture['lecture_name'] ?? 'no_name'.tr,
              ...
              /// 📋 DETAILS
              _buildItem("date".tr, lecture['created_at']),
              _buildItem("doctor".tr, lecture['doctor_name']),
              _buildItem("notes".tr, lecture['notes']),
            ],
          ),
        );
      }),
