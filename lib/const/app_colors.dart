...
class AppColors {
  /// 🔥 Primary Colors (الأساسية) - نفسها بالوضعين لأنها هوية العلامة
  ...
  /// 🤍 ألوان عامة (استخدميها بحذر، الأفضل الاعتماد على Theme)
  static const Color white = Colors.white;
  static const Color transparentWhite = Color(0x26FFFFFF); // 15% opacity

  /// ⚠️ أسماء قديمة (Legacy) — لسا مستخدمة بشاشات ما اتحدّثت بعد.
  /// لما تخلصي تحدّثي كل الشاشات لتستخدم Theme.of(context)، ممكن تحذفي هاد القسم كامل.
